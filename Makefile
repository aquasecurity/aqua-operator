...
# aquasec.com/aqua-oprator-bundle:$VERSION and aquasec.com/aqua-oprator-catalog:$VERSION.
IMAGE_TAG_BASE ?= aquasec/aqua-operator
...
.PHONY: docker-build
# enable for testing before build
