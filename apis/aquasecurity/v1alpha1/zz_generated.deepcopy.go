...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AquaTrivy) DeepCopyInto(out *AquaTrivy) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AquaTrivy.
func (in *AquaTrivy) DeepCopy() *AquaTrivy {
	if in == nil {
		return nil
	}
	out := new(AquaTrivy)
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *AquaTrivy) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AquaTrivyList) DeepCopyInto(out *AquaTrivyList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]AquaTrivy, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AquaTrivyList.
func (in *AquaTrivyList) DeepCopy() *AquaTrivyList {
	if in == nil {
		return nil
	}
	out := new(AquaTrivyList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *AquaTrivyList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AquaTrivySpec) DeepCopyInto(out *AquaTrivySpec) {
	*out = *in
	if in.Infrastructure != nil {
		in, out := &in.Infrastructure, &out.Infrastructure
		*out = new(operatorv1alpha1.AquaInfrastructure)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AquaTrivySpec.
func (in *AquaTrivySpec) DeepCopy() *AquaTrivySpec {
	if in == nil {
		return nil
	}
	out := new(AquaTrivySpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AquaTrivyStatus) DeepCopyInto(out *AquaTrivyStatus) {
	*out = *in
	if in.Nodes != nil {
		in, out := &in.Nodes, &out.Nodes
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AquaTrivyStatus.
func (in *AquaTrivyStatus) DeepCopy() *AquaTrivyStatus {
	if in == nil {
		return nil
	}
	out := new(AquaTrivyStatus)
	in.DeepCopyInto(out)
	return out
}
